...
public class Utils {
    ...
    /**
     * Gathers all the files in the given directory recursively. If a subdirectory is found, its contents will be gathered as well.
     * @param directory the directory that will be iterated through
     * @return the list of all the files found in the given directory, or an empty list if an error occurs
     */

    public static List<File> getFilesInDirectory(File directory) {
        File[] files = directory.listFiles();
        if (files == null) {
            System.out.println("[FATAL] Could not find directory \"" + directory.getName() + "\"!");
